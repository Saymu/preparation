...
/*
 Une « factory method » est un design pattern qu'on utilise quand on ne connaît pas à l'avance le type exact d'une instance à produire: 
 on passe alors par une méthode (la « factory method ») qui devra, en fonction de certains critères, faire le choix du type à produire.
 */
